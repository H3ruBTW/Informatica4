...
<input type="text" name="codicefis" placeholder="MRIRSS..." pattern="[a-zA-Z]{6}[\d]{2}[a-zA-Z][\d]{2}[a-zA-Z][\d]{3}[a-zA-Z]">
<br><br>
<label for="mail">E-mail:</label>
<input type="email" name="mail" placeholder="mario.rossi@mail.*" required>
<label for="cellnumber" pattern="[0-9]{11,12}">Numero di cellulare:</label>
<input type="tel" name="tel" placeholder="39 333 333 3333" required>
...
<input type="text" name="prov" placeholder="MI" pattern="[a-zA-Z]{2}" required>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $mail = $_POST["mail"];
    $tel = $_POST["tel"];
    $ind = $_POST["tipo"] . " " . $_POST["via"] . ", " . $_POST["prov"] . " " . $_POST["comune"];
    $user = $_POST["user"];
    $pass = $_POST["password"];
